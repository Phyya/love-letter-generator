  ...
  return (
    ...
    <div className="p-6 sm:p-10 md:p-12 lg:p-20 xl:p-24 2xl:px-48">
      ...
      <div className="lg:text-center space-y-4 mb-12 mt-36">
        <h1 className="text-4xl sm:text-4xl font-black">Privacy policy</h1>
        ...
        <div className="space-y-10 sm:text-justify ">
          <div className="text_div">
            <p>
              ...
              LoveMe website, you consent to the data practices described in
              this statement.
            </p>
          </div>
          ...
          <div className="text_div space-y-7">
            ...
            <p>
              ...
              LoveMe may collect personally identifiable information, such as
              your:
            </p>
            ...
            <p>
              ...
              However, you may be required to provide certain personal
          ...
          <div className="text_div space-y-7">
            ...
            <p>
              LoveMe collects and uses your personal information to operate and
              deliver the services you have requested.
            </p>
            <p>
              LoveMe may also use your personally identifiable information to
              inform you of other products or services available from LoveMe and
              its affiliates.
            </p>
            <p>
              We may store photographs, images and other content uploaded or
              submitted to the Site - and information about any such photographs
              and images - in order to provide products and services, improve
              our products and services, garner insights and information about
              our users, and to fulfil orders. Our printing and assembly process
              requires human involvement, so LoveMe employees and vendors will
              see your photographs, images and other content that you submit to
              the Site. We do not otherwise use the photographs, images or
              content in a manner that would identify you personally.
            </p>
          </div>
          ...
          <div className="text_div space-y-7">
            ...
            <p>
              ...
              to provide these services to LoveMe, and they are required to
              maintain the confidentiality of your information.
            </p>
            <p>
              LoveMe may disclose your personal information, without notice, if
              required to do so by law or in the good faith belief that such
              action is necessary to: (a) conform to the edicts of the law or
              comply with legal process served on LoveMe or the site; (b)
              protect and defend the rights or property of LoveMe; and/or (c)
              act under exigent circumstances to protect the personal safety of
              users of LoveMe, or the public.
            </p>
          </div>
          ...
          <div className="text_div space-y-7">
            ...
            <p>
              ...
              within LoveMe, in order to determine what LoveMe services are the
              most popular. This data is used to deliver customised content and
              advertising within LoveMe to customers whose behaviour indicates
          ...
          <div className="text_div space-y-7">
            ...
            <p>
              ...
              to provide general statistics regarding use of the LoveMe website.
            </p>
          </div>
          ...
          <div className="text_div space-y-7">
            ...
            <p>
              ...
              if you personalise LoveMe pages, or register with LoveMe site or
              services, a cookie helps LoveMe to recall your specific
              ...
              shipping addresses, and so on. When you return to the same LoveMe
              website, the information you previously provided can be retrieved,
              so you can easily use the LoveMe features that you customised.
            </p>
            <p>
              ...
              the interactive features of the LoveMe services or websites you
              visit.
            </p>
          </div>
          ...
          <div className="text_div space-y-7">
            ...
            <p>
              LoveMe secures your personal information from unauthorised access,
              use, or disclosure. LoveMe uses the following methods for this
              purpose:
            </p>
            <p>SSL Protocol</p>
            <p>
            ...
            <p>
              ...
              unauthorised access to or alteration of your personal information.
          ...
          <div className="text_div space-y-7">
            ...
            <p>
              You can request us to erase any personal data we hold about you by
              emailing us at info@loveme.com. Please include the email address
              used when you registered on the site.
            </p>
            <p>
          ...
          <div className="text_div space-y-7">
            ...
            <p>Disconnecting your LoveMe Account from Third Party Websites:</p>
            <p>
              ...
              account at any time. Users&apos; connections to third party site
              (e.g. Facebook, Instagram) are disconnected when the user ends
              their session (i.e. navigates away from the website).
            </p>
          </div>
          ...
          <div className="text_div space-y-7">
            ...
            <p>
              ...
              you open an email from LoveMe or click on a link therein.
            </p>
            <p>
          ...
          <div className="text_div space-y-7">
            ...
            <p>
              LoveMe reserves the right to change this Privacy Policy from time
