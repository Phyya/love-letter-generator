...
const Patnership = () => {
  ...
  return (
    <PatnershipWrapper>
      ...
      <WhyJoinSection>
        <h1 className="why__join__header">Why you should join as a Partner?</h1>
        ...
        <ul className="how__to__join grid" style={{ marginTop: '30px' }}>
          <article className="how__to__join__card">
            ...
            <p className="article__description">
              Quality and the right partners are important to us. Thats’s why we
          ...
          <article className="how__to__join__card">
            ...
            <p className="article__description">
              You recieve a recurring commission of 35% each time subsbcription
              renews
            </p>
          </article>
        </ul>
