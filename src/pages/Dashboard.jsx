...
function Dashboard() {
  const [letters] = useState([
    {
      text: 'Love notes curated for your loved one, and  scheduled to be sent out in the morning',
      id: 1,
      completed: true,
    },
    {
      ...
      <main className="main">
        ...
        <section className="bottomsec">
          <div className="bottomsec-top">
            <div
              className={
                completed ? 'bottomsec-topleft' : 'bottomsec-topleftunactive'
              }
              onClick={handleCompletedClick}
            >
              <p>
                Completed{' '}
                <span className={completed ? 'spanred' : 'spangrey'}></span>
              </p>
            </div>
            <div
              className={
                completed ? 'bottomsec-topleftunactive' : 'bottomsec-topleft'
              }
              onClick={handlescheduledClick}
            >
              <p>
                Scheduled{' '}
                <span className={completed ? 'spangrey' : 'spanred'}></span>
              </p>
            </div>
          </div>

          {letters ? (
            <div className={list ? 'bottomsec-btm' : 'bottomsec-btm-grid'}>
